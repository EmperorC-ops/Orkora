 ...
 * APIs, so this module renders in both the public server tree (StoryRenderer)
 * and the client composer preview (StoryPreview). Keep it that way: anything
 * added here must be safe in both environments.
 *
 * Agenda and Tickets render from the event's own data (sessions, tiers) rather
 * than block content, so they always reflect the live event.
 */
